...
- If new project (not fork):
  - Copy [eldivinobycosafina.com project files](https://github.com/eldivinobycosafina/eldivinobycosafina.com)
...
- `README.md` ⏩ edit baseURL ("eldivinobycosafina.com") + delete steps bit by bit
- Design
...
- If Netlify
  - [`Domain Management / settings`](https://app.netlify.com/sites/eldivinobycosafina/settings/domain)
  - `Add custom domain`
  - `Check DNS configuration` Copy
  - Add `DNS Records` copied from Netlify to Domain gestor:
    - From: `eldivinobycosafina.com`
    ...
    - From: `www`
      DNS Record: `CNAME`
      To: `eldivinobycosafina.netlify.app.`
...
- If Cloudflare Pages
  - [Custom domains](https://dash.cloudflare.com/?to=/:account/pages/view/eldivinobycosafina/domains)
  - `Set up a custom domains`
  - `eldivinobycosafina.com`
  - `Continue`
  - `Activate domain` (if `Begin DNS transfer` end)
  - Repeat with `www.eldivinobycosafina.com`
  - ...........................................................
...
- If Netlify Form
  ...
  - [`Netlify ⏩ Site ⏩ Forms ⏩ Form Notifications`](https://app.netlify.com/sites/eldivinobycosafina/settings/forms#form-notifications) ⏩ `Add notification ⏩ Email notification ⏩ Email to Notify`
    - `Email to notify` = Emails of collaborators that want receive submissions
    - `Custom email subject line` = `Formulario de contacto de eldivinobycosafina.com`
    - `Save`
  - Submissions: [`Netlify site ⏩ Forms`](https://app.netlify.com/sites/eldivinobycosafina/forms)
...
1. [Servicios eldivinobycosafina.com](https://drive.google.com/file/d/1trq28fMfEVwoZOk4ue0tJzAJDZtj64BK) ⏩ `File ⏩ Make a copy` ⏩ Select client directory.
1. Change the info.
...
```
*ENTREGA WEB eldivinobycosafina.com:* https://seacomoseo.com/entrega/
```
